                ...
                <form method="POST" action="{{ route('users.store') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <select name="department" id="department" required
                            ...
                            <option value="administracion" {{ old('department') == 'administracion' ? 'selected' : '' }}>Administración</option>
                            <option value="ventas" {{ old('department') == 'ventas' ? 'selected' : '' }}>Ventas</option>
                            <option value="compras" {{ old('department') == 'compras' ? 'selected' : '' }}>Compras</option>
                        </select>
                        @error('department')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
